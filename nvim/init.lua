...
-- Disable all LSP diagnostics (linting) while keeping LSP features
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      -- Document existing key chains (which-key v3: use add() with group = …)
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      vim.cmd.hi 'CursorLine guibg=#3a3a4a cterm=NONE gui=NONE'
      vim.cmd.hi 'Visual guibg=#3a3a4a gui=NONE'
    end,
  },
